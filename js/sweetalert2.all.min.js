! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() {
    ...
    function Oe(t, e, n) { St.innerParams.get(t).toast ? Qe(t, e, n) : (Je(e), Xe(e), Ge(t, e, n)) }
    ...
    var on, rn = function(t) { for (var e in t) t[e] = new WeakMap },
        an = Object.freeze({
            ...
            _main: function(t) {
                ...
                var n = function(t) { var e = { popup: $(), container: Q(), content: P(), actions: T(), confirmButton: E(), cancelButton: O(), closeButton: I(), validationMessage: B(), progressSteps: S() }; return St.domCache.set(t, e), e }(this);
        ...
        cn = function() {
            ...
            return c(r, [{ key: "then", value: function(t) { return St.promise.get(this).then(t) } }, { key: "finally", value: function(t) { return St.promise.get(this).finally(t) } }]), r
        }();
    s(cn.prototype, an), s(cn, oe), Object.keys(an).forEach(function(t) { cn[t] = function() { if (on) return on[t].apply(on, arguments) } }), cn.DismissReason = K, cn.version = "9.15.2";
    var sn = cn;
